...
const Header = (props) => {
  return (
    <nav className="px-2 dark:bg-slate-900 dark:shadow-none bg-emerald-100 shadow-md shadow-slate-200 sm:px-4 border-b border-primary-color dark:border-slate-600 py-2.5 dark:bg-blue">
